...
#define R__DICTIONARY_FILENAME dIafsdIcerndOchdIuserdIadIaltaylordItthh_bbbb_smeardIRootCoreBindIobjdIx86_64mIslc6mIgcc48mIoptdIMyAnalysisdIobjdIMyAnalysisCINT
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::MyxAODAnalysis*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("MyxAODAnalysis", ::MyxAODAnalysis::Class_Version(), "MyAnalysis/MyxAODAnalysis.h", 20,
...
"/afs/cern.ch/user/a/altaylor/tthh_bbbb_smear/MyAnalysis/Root",
"/afs/cern.ch/user/a/altaylor/tthh_bbbb_smear/MyAnalysis",
"/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/root/6.02.05-x86_64-slc6-gcc48-opt/include",
"/afs/cern.ch/user/a/altaylor/tthh_bbbb_smear/RootCoreBin/include",
"/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/root/6.02.05-x86_64-slc6-gcc48-opt/include",
"/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/root/6.02.05-x86_64-slc6-gcc48-opt/include",
"/afs/cern.ch/user/a/altaylor/tthh_bbbb_smear/MyAnalysis/cmt/",
0
    };
...
class __attribute__((annotate("$clingAutoload$/afs/cern.ch/user/a/altaylor/tthh_bbbb_smear/MyAnalysis/Root/LinkDef.h")))  MyxAODAnalysis;
)DICTFWDDCLS";
